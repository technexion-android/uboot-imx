...
#define UPDATE_M4_ENV \
	...
	"loadm4image=load mmc ${mmcdev}:${mmcpart} ${tcm_addr} ${m4image}\0" \
	"update_m4_from_sd=" \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"setfdt=setenv fdt_file ${som}-${baseboard}.dtb\0" \
...
#define CONFIG_SYS_MMC_ENV_DEV		0   /* USDHC1 or USDHC3 */
...
#include "tep1-imx7dandroid.h"
#elif defined(CONFIG_ANDROID_THINGS_SUPPORT)
#include "tep1-imx7dandroidthings.h"
#else
...
#define VARIANT_NAME "imx7d_tep1"
