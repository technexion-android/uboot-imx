...
#ifndef __TEK_IMX8MP_H
#define __TEK_IMX8MP_H
...
#define CONFIG_SPL_MAX_SIZE		(157 * 1024)
...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"loadoverlay=" \
		...
		"for ov in ${dtoverlay}; do " \
			"echo Overlaying ${ov}...; " \
			"fatload mmc ${mmcdev}:${mmcpart} ${fdtovaddr} imx8mp-tek-${ov}.dtbo && fdt apply ${fdtovaddr}; " \
		"done\0" \
